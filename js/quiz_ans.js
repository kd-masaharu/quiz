const data = [
	...
	},
	{
		...
		"correct":"3",
		"explanation":"「いらっしゃる」は尊敬語、「おいでになる」は尊敬語、「おられます」謙譲語 ソース//(https://x.gd/vbLnM)なので答えは3になる。"
	},
	{
		"questionId":"6",
		"genreId":"4",
	...
	},
	{
		...
		"correct":"1",
		"explanation":"かしこまりました、承知しました、わかりました。は正しい敬語となります。ソース//(https://x.gd/2HwGA)"
	},
	{
		"questionId":"12",
		"genreId":"4",
		...
		"correct":"3",
		"explanation":"1,4は「ご苦労さま」は目上の人が目下の人に対して使う言葉として一般的に考えられているため不適切です。2は「お疲れさま」は体言止めのめ、ぶっきら棒な言い方になり適切ではありません。ソース//(https://x.gd/2HwGA)"
	},
	{
		"questionId":"13",
		"genreId":"4",
		...
		"correct":"2",
		"explanation":"問1,3,4は正しい敬語であり、間違っている答えは問2だけになります。ソース：https://x.gd/q412J"
	},
	{
		"questionId":"14",
		"genreId":"3",
		...
		"correct":"3",
		"explanation":"○○に休みを取らせているのは会社なので、電話口で聞かれたときに自社に敬意を示す必要はありません。したがって、「休みをいただく」は不切です。またＡ「休みです」はぶっきらぼうな言い方のため、不適切な言い方になります。ソース//(https://x.gd/NXAyP) "
	},
	{
		"questionId":"15",
		"genreId":"3",
		...
		"correct":"2",
		"explanation":"ご持参だけだと正しい日本語ではなく、持ってきてと持参だと正しい敬語ではなくなるため答えは2ソース//(https://x.gd/cUaVe)"
	},
	{
		"questionId":"16",
		"genreId":"3",
		...
		"correct":"2",
		"explanation":"顧客の問題を理解し、できる限り即座に解決策や手順を提供することは、効果的な顧客サービスの提供方法です。(ソース https://x.gd/SzyIS )"
	},
	{
		"questionId":"17",
		"genreId":"3",
		...
		"correct":"3",
		"explanation":"顧客の不快な気持ちを和らげるために謝罪し、問題解決のために詳細を聞くことが重要です。顧客の不満や問題を真剣に受け止め、解決に向けてサポートする姿勢を示すことが重要です。ソース( https://x.gd/YjRGa ) "
	},
	{
		"questionId":"18",
		"genreId":"3",
		...
		"correct":"1",
		"explanation":"顧客からの問いに対し、弊社のサービスのメリットを具体的な例やデータを用いて説明することが重要です。抽象的な主張よりも、具体的な事例やデータを提示することで、顧客により詳細で信憑性のある情報を提供することができます。(ソース https://x.gd/X41XN ) "
	},
	{
		"questionId":"19",
		"genreId":"3",
		...
		"correct":"2",
		"explanation":"顧客の返品に対して具体的な手続きや詳細を説明し、返品の可能性について示すことが重要です。顧客が返品を希望する理由や状況を理解し、適切な手順を案内することで、円滑な返品プロセスをサポートできます。(ソース https://x.gd/Exenl ) "
	},
	{
		"questionId":"20",
		"genreId":"3",
		...
		"correct":"1",
		"explanation":"顧客からの報告に対し速やかに謝罪し、遅延の原因を調査して詳細を提供することが重要です。(ソース https://x.gd/GtDb9 )  "
	},
	{
		"questionId":"21",
		"genreId":"3",
		...
		"correct":"4",
		"explanation":"破損した商品に関する詳細や証拠として写真を要求し、事態を調査することが重要です。顧客の報告を真摯に受け止め、問題の原因を明らかにすることで、適切な解決策を見つけることができます。(ソース https://x.gd/0skzL  ) "
	},
	{
		"questionId":"22",
		"genreId":"3",
		...
		"correct":"3",
		"explanation":"顧客の主張に謝罪し、不良品に関する詳細を確認するために顧客から追加情報を求めることが重要です(ソース  https://x.gd/jZqei )"
	},
	{
		"questionId":"23",
		"genreId":"3",
		...
		"correct":"2",
		"explanation":"顧客の報告に対して謝罪し、報告内容を確認し、不足している商品に関する詳細を求めることが重要です。(ソース https://x.gd/598OZ ) "
	},
	{
		"questionId":"24",
		"genreId":"3",
		...
		"correct":"1",
		"explanation":"顧客の要求を拒否し、ポリシーに基づいて返品を受け付けられないことを説明することが重要です。ポリシーに基づいて公平かつ一貫した対応を行うことが、顧客との信頼を保つ上で重要です。(ソース  https://x.gd/C8Zi3 )"
	},
	{
		"questionId":"25",
		"genreId":"2",
		...
		"correct":"1",
		"explanation":"「TO」とは、宛先の意味があります。メインでメールを送りたい相手のアドレスを入力します。「記載している内容の作業をして欲しい」などの用件を伝えたい、送ったメールに返信がほしい、などのメール内容を、「あなた宛のメールです」と伝える役割があります。https://x.gd/4nFBP "
	},
	{
		"questionId":"26",
		"genreId":"2",
		...
		"correct":"3",
		"explanation":"(了解しましたが、それは難しい課題です)了解の表現は良いですが、少し否定的なニュアンスが含まれています。(かしこまりましたが、私はそのプロジェクトに参加することができません)かしこまりましたは丁寧ですが、(参加することができませんという表現がやや直接的です(承知いたしましたが、私のスケジュール上、難しい状況です) 承知いたしましたは謙譲語で、理由も丁寧に説明しています。(分かりましたが、それには参加できません)分かりましたも適切ですが、理由を追加することでより丁寧になります。ソース「 https://x.gd/eYTyX 」"
	},
	{
		"questionId":"27",
		"genreId":"2",
		...
		"correct":"4",
		"explanation":"解説:見出しは独立した意味を持つべきですが、それが文章全体の完全な意味を伝える必要はありません。見出しは本文の要約や焦点を示すものであり、本文の内容を明確に示し、適切な階層構造を保ちつつ、読者が本文を理解しやすくすることが重要です。ソース: https://blog.qbist.co.jp/?p=4596"
	},
	{
		"questionId":"28",
		"genreId":"2",
		...
		"correct":"3",
		"explanation":"解説；接続詞は文章をつなげる役割を果たし、読み手が文の流れを理解しやすくします。ただし、過剰な接続詞の使用は文を複雑にし、理解を難しくすることもあります。そのため、必要な場面で適切に接続詞を使うことが重要です。ソース:https://webtan.impress.co.jp/e/2017/08/18/26274"
	},
	{
		"questionId":"29",
		"genreId":"2",
		...
		"correct":"2",
		"explanation":"解説 :逆接や順接どちらも含む接続詞で、「さらに」「その上」という意味で使われますが、単独で順接を示すのではなく、文脈によって意味が変わります。ソース: https://next.rikunabi.com/journal/20160819_1/"
	},
	{
		"questionId":"30",
		"genreId":"2",
		...
		"correct":"2",
		"explanation":"解説；「頂く」という言葉は、謙譲の意味を持ち、相手に対する敬意を示すために使われます。この言葉は、受身形で自分が何かを受け取る際に使用されます。例えば、「お客さまからお土産を頂いた」という文は、自分がお客さまから何かを受け取ったことを謙虚に表現しています。ソース;https://go.chatwork.com/ja/column/business_chat/business-chat-374.html#:~:text=「頂く」は、自分の,に注意が必要です。"
	},
	{
		"questionId":"32",
		"genreId":"1",
		...
		"correct":"3",
		"explanation":"1,2,4番は雇用保険の目的ですが、3番は社会保険の目的です。(ソース:https://x.gd/ggfU2) "
	},
	{
		"questionId":"33",
		"genreId":"1",
		...
		"correct":"2",
		"explanation":"解説：社会保険料のうち、「雇用保険料」は当月から差し引きされますが、「健康保険料」と「厚生年金保険料」は、通常前月の支払い分を翌月の給料から差し引かれます。住民税は住民税は前年の所得をもとにして納める税金のため、前年度の所得によって変わります。(ソース:https://x.gd/h7DJC) "
	},
	{
		"questionId":"34",
		"genreId":"1",
		...
		"correct":"3",
		"explanation":"1,000円から194万9,000円までが5%、195万円から329万9,000円までが10%、330万円から694万9,000円までが20%、695万円から899万9,000円までが23%になります。(ソース:https://x.gd/5wJLi) "
	},
	{
		"questionId":"35",
		"genreId":"1",
		...
		"correct":"4",
		"explanation":"解説：正解は４の課税所得金額×税率－控除額です。(ソース:https://x.gd/ym15J) "
	},
	{
		"questionId":"36",
		"genreId":"1",
		...
		"correct":"2",
		"explanation":"払わなかった場合は、催促状が届く→財産調査→差し押さえの順番で行われます。(ソース:https://x.gd/Fgftv)"
	},
	{
		"questionId":"37",
		"genreId":"1",
		...
		"correct":"4",
		"explanation":"所得税、法人税、贈与税は国税ですが、自動車税は地方税です。(ソース:https://x.gd/apF9d)"
	},
	{
		"questionId":"38",
		"genreId":"1",
		...
		"correct":"1",
		"explanation":"所得税は650万円あたりから急激に上がり始め、780万円あたりから住民税よりも高くなります。基礎控除のみの給与所得でシミュレーションすると、年収700万円が損得の分岐点といえます。そのため、690万前後がコスパの良い年収になります。(ソース:https://x.gd/5u8Cg) "
	},
	{
		"questionId":"39",
		"genreId":"1",
		...
		"correct":"3",
		"explanation":"納付を待ってもらえる期間は、原則として１年間が限度になっています。(ソース:https://x.gd/DMl42)"
	},
	{
		"questionId":"40",
		"genreId":"1",
		...
		"correct":"4",
		"explanation":"贈与税、消費税、酒税は国税で、住民税は地方税です。(ソース:https://x.gd/apF9d)"
	},
	{
		"questionId":"41",
		"genreId":"2",
		...
		"correct":"3",
		"explanation":"「CC」とは、カーボン・コピー（Carbon Copy）の略で、「複写」の意味があります。TOの宛先となる人の他に、内容を共有したい相手のアドレスを入力すると、同じ（複写）メールが送信されます。https://x.gd/4nFBP "
	},
	{
		"questionId":"42",
		"genreId":"2",
	...
	},
	{
		...
		"correct":"4",
		"explanation":"ビジネスメールの署名には必要最小限の情報を含め、他者とのコミュニケーションに必要な要素に絞ることが一般的です。https://x.gd/gy23l "
	}
]
